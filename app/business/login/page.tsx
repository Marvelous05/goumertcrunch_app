...
export default function BusinessLoginPage() {
  const [email, setEmail] = useState("business@goumert.co.zw");
      ...
      <div className="card" style={{ maxWidth: 680, margin: "0 auto" }}>
        <div className="section-heading">
          ...
          <div>
            ...
            <p className="small-note">Sign in to manage orders, inventory, analytics, and reports with a polished dashboard.</p>
          </div>
        </div>
